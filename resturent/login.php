...
main {
    ...
    height: 75vh;
    width: 100%;
    background-image: url(https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Mountains-1412683.svg/1280px-Mountains-1412683.svg.png);
...
<body>
    ...
    <main>
        <form id="login_form" class="form_class" action="code_li.php" method="POST">
            <div class="form_div">
                ...
                <button class="submit_class" type="submit" name="login">LOG IN</button>
            </div>
            <div class="info_div">
